            ...
            <div className={modalClassName}>
              <div>
                <div>
                  <Dialog.Title
                    as="div"
                    className={divideHeader ? 'flex pb-6 border-b px-6' : 'flex'}
                  >
...
MobileModal.defaultProps = {
  ...
  modalClassName:
    'w-full inline-block align-bottom bg-body-background-color rounded-t-lg sm:rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6',
  divideHeader: false,
}
