        ...
        <Transition.Root show={open} as={Fragment}>
            ...
            >
                <div className="flex md:items-center items-end justify-center min-h-screen pt-4 px-0 md:px-4 pb-0 md:pb-20 text-center">
                    ...
                    >
                        <div className="inline-block align-bottom bg-body-background-color rounded-t-lg rounded-b-lg md:rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            <div>
                                <div>
