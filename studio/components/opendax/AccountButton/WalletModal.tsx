        ...
        {connectors.map(({ id, name, icon }, i) => (
          ...
          >
            {isMetaMaskInstalled || id !== 'Injected' ? (
              ...
              >
                <span className="flex pr-4 text-neutral-control-layer-color-100">{name}</span>
                {id === 'Injected' && (
                    ...
                    <TooltipPrimitive.Root delayDuration={0}>
                      ...
                      <TooltipPrimitive.Content>
                        <div className="bg-connector-networks-info text-white rounded p-3 w-64 text-left">
                          ...
                          <ol className="list-none p-0 m-0">{supportedChainsList}</ol>
                        </div>
                      </TooltipPrimitive.Content>
      ...
      <div className="p-2 sm:p-3">
        <div className="text-base text-neutral-control-layer-color-50">
          <p>
            ...
            <Link href="#">
              <a ref={ctaButtonRef} className="text-base text-secondary-cta-color-60 truncate">
                Terms of Service
              </a>
            </Link>
          </p>
    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="relative z-[99999] inline-block align-bottom bg-body-background-color rounded-b-lg rounded-t-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              <div>
              ...
              <div className="mt-3">{renderTermsOfService}</div>
            </div>
          </Transition.Child>
        </div>
      </Dialog>
